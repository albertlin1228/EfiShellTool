...
typedef enum {
  ...
  // APTIOV_SERVER_OVERRIDE_START: Add for smbios 3.2
  MemoryTypeLogicalNvDevice                = 0x1F
  // APTIOV_SERVER_OVERRIDE_END: Add for smbios 3.2
} MEMORY_DEVICE_TYPE;
...
//APTIOV_SERVER_OVERRIDE_START: Build Error due to missing SMBIOS spec update
///
...
//APTIOV_SERVER_OVERRIDE_END: Build Error due to missing SMBIOS spec update
///
